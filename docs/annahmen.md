...
| A7 | KI-Modell | KI hinter Provider-Abstraktion. **Default: `fake`** (deterministisch, ohne Secret). Echter Provider: **Anthropic Claude** (`claude-opus-4-8`, per ENV). | §14.2: datenschutzkonforme, austauschbare KI; deterministische Tests; keine Secrets im Repo. |
